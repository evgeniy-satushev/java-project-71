...
public class ParserTest {
    ...
    void generateTest() {
        ...
        String expected3 = "";
        try {
            expected1 = Differ.generate(Parser.getData(filepathYaml1), Parser.getData(filepathYaml2));
            expected2 = Differ.generate(Parser.getData(filepathJson1), Parser.getData(filepathJson2));
            expected3 = Differ.generate(Parser.getData(emptyFile), Parser.getData(emptyFile));
        } catch (IOException e) {
